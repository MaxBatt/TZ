...
$(window).load(function() {
	$(".google-maps").gmap3({
    marker:{     
address:"St.-Martin-Str. 2, Garmisch-Partenkirchen",  options:{icon: "img/marker.png"}},
    map:{
      options:{
	zoom: 15,
	scrollwheel:false,
